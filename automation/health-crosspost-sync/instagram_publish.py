...
# 이 저장소(hidden-benefit)의 raw 파일 경로. 브랜치/경로를 바꾸면 여기도 맞춰 바꿔야 한다.
RAW_BASE = (
    "https://raw.githubusercontent.com/72kang81-tech/hidden-benefit/main/"
    "automation/health-crosspost-sync/instagram_cards"
)
